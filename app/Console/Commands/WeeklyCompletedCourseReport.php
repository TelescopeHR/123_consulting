...
class WeeklyCompletedCourseReport extends Command
{
    use SendEmail;
     ...
     * @var string
     */
    protected $signature = 'weekly:completed-course-report';
    ...
    public function handle()
    {
        ...
        if ($lastWeekCourses && count($lastWeekCourses)) {
            ...
            $subject = 'Weekly Report For 8 Hour Initial Administrator Training - 123 Consulting Solutions';
