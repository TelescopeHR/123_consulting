...
<head>
	...
	<!-- favicon icon -->
	<link rel="icon" href="{{ asset('assets/images/favicon-icon.png') }}" sizes="32x32">
	...
	<link rel="stylesheet" href="{{ asset('newhtml/css/style.css') }}" />
		...
		<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="bttn button-primary d-flex align-items-center" href="{{ route('cart') }}" title="Go to Cart">
					...
					if (response.status) {
						...
						if ($(".metabox-addtocart").length) {
							$(".metabox-addtocart").html(
								`<a href="{{ route('cart') }}" class="btn button-primary px-5 card-addto-cart-btn course-details-pricing-addtocart w-100 justify-content-center" title="Go to Cart">Go to Cart</a>`
							)
						}
